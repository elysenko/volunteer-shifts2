...
const SEED_USERS = [
    { email: 'admin@demo.org', name: 'Demo Admin', role: client_1.Role.ADMIN, password: 'admin1234' },
    { email: 'sam@demo.org', name: 'Sam Rivera', role: client_1.Role.USER, password: 'volunteer1' },
    { email: 'jo@demo.org', name: 'Jo Chen', role: client_1.Role.USER, password: 'volunteer2' },
];
